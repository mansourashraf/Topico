...
function getCartItems() {
    ...
    for (let i = 0; i < product_cart.length; i++) {
        items_c +=`
          ...
          <div class="item_cart">
                ...
                <button onclick="remove_from_cart(${i})" class="delet_item"><i class="fa-solid fa-trash i"></i></button>
            </div>
    ...
    count_item_cart.innerHTML = `(${product_cart.length}0Item in cart)`;
